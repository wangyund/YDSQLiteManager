Pod::Spec.new do |s|
  s.name     = 'YDSQLiteManager'
  s.version  = '1.0.0'
  s.license  = 'MIT'
  s.summary  = 'A delightful iOS and OS X SQLiteManager framework.'
  s.homepage = 'https://github.com/wangyund/YDSQLiteManager'
  s.social_media_url = 'https://github.com/wangyund'
  s.authors  = { 'wangyund' => 'wuyezhiguhun@163.com' }
  s.source   = { :git => 'https://github.com/wangyund/YDSQLiteManager.git', :tag => s.version, :submodules => true }
  s.requires_arc = true
